                ...
                <div class="modal-content">
                                ...
                                <template v-if="statusRecord !== 4">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <input type="text"
                                                   ...
                                                   autocomplete="off">
                                            <small v-for="message in errorValidate.name" class="text-danger">{{
                                                    message
                                                }}</small>
                                            ...
                                            <div v-if="isActiveSearch" class="panel-footer"
                                                ...
                                                <ul class="list-group">
                                                    <a href="#" @click.prevent="pasteName(name, phone)"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <small v-for="message in errorValidate.phone" class="text-danger">{{
                                                    message
                                                }}</small>
                                        </div>
                                    </div>
                    ...
                    <textarea name="comment"
                            ...
                            <div class="card-footer">
                                ...
                                <button v-if="statusRecord === 2" @click.prevent="confirmRecord()"
                                ...
                                <button class="btn btn-danger float-right" @click.prevent="deleteRecord()">Удалить
                                </button>
                            </div>
                            <!-- /.card-footer -->
                        </form>
...
export default {
    ...
    methods: {
        cancelRecord() {
            axios.put(`/api/admin/records/cancel/${this.recordId}`, {}, {
                //headers: {'Authorization': 'Bearer fjheu834jd740dk3j59djh3948dk3498e'},
            })
                .then((response) => {
                    if (response.data) {
                        ...
                        //this.successTitleMessage = 'Успешно отменено'
